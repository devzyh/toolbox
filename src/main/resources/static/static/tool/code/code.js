layui.use(function () {
    ...
    $("#encrypt").click(function () {
        let input = $("#cryptInput").val()
        let password = $("#cryptPassword").val()
        let output
        try {
            switch ($("input[name='cryptAlgorithm']:checked").val()) {
                case "AES":
    ...
    $("#ttxEncrypt").click(function () {
        let data = {
            "input": $("#ttxInput").val(),
            "password": $("#ttxPassword").val()
        }
        $.post("/rest/ttx/encrypt", data, function (res) {
            $("#ttxOutput").val(res)
        })
    })
    ...
    $("#ttxDecrypt").click(function () {
        ...
        $.post("/rest/ttx/decrypt", data, function (res) {
            $("#ttxOutput").val(res)
        })
    })
