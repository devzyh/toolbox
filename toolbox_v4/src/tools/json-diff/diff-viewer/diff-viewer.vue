...
<template>
  <div v-if="showResults" class="mw-600">
    <div flex justify-center>
      <n-form-item :label="translate('tools.json-diff.only-show-differences')" label-placement="left">
    ...
    <c-card data-test-id="diff-result">
      <div v-if="jsonAreTheSame" text-center op-70>
        {{ translate('tools.json-diff.the-provided-jsons-are-the-same') }}
      </div>
